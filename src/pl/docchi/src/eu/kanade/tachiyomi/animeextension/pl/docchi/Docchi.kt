...
class Docchi :
    ...
    override fun popularAnimeParse(response: Response): AnimesPage {
        val animeArray = response.parseAs<List<ApiList>>()
    ...
    private val lycorisExtractor by lazy { LycorisExtractor(client, headers) }
        ...
        return serverList.parallelCatchingFlatMapBlocking { (serverUrl, prefix, playerName) ->
            when {
                ...
                serverUrl.contains("rumble.com") -> {
                    rumbleExtractor.videosFromUrl(serverUrl, prefix)
                }
